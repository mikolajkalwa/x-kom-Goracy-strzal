    ...
    try {
        ...
        const produkt = await page.evaluate(() => {
            const przecenionyProdukt = {
                ...
                pozostalo: document.querySelector('#hotShot > div:nth-child(2) > div:nth-child(2) > div.clearfix.count > div.pull-left > strong'),
                sprzedano: document.querySelector('#hotShot > div:nth-child(2) > div:nth-child(2) > div.clearfix.count > div.pull-right > strong'),
